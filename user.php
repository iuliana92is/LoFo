...
<script type="text/javascript">
    function inchidereModal() {
      document.getElementById("modalAnunt").setAttribute("class", "hidden");
    }
...
<article class="user">
	...
	<section id="anunturiUtilizator"> 
        <ul class="infoAnunt">
             ...
             <li class="  anuntInfos editareAnunt" onclick="editareModal()" >editare</li>
...
<script type="text/javascript">
    function editareModal() {
      document.getElementById("modalAnunt").setAttribute("class", "active");
    }
